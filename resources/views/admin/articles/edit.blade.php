...
@section('content')
    ...
    <div class="content container-fluid">
    	...
    	<form method="post" action="{{ route('articles.update', $article->id) }}" enctype="multipart/form-data" id="article_edit_form">
    		@csrf()
					        	...
					        	<div class="row">
					        		<div class="col-md-12">
					        			<div class="form-group">
											...
											<input type="text" name="title" id="title" class="form-control @error('title') form-control-error @enderror" required="required" value="{{$article->title}}">
										...
										<div class="form-group">
											...
											<input type="text" name="slug" id="slug" class="form-control" disabled value="{{$article->slug}}">
										...
										<div class="form-group">
											...
											<textarea name="description" id="description" class="form-control @error('description') form-control-error @enderror" style="height: 80vh" required="required">{{$article->description}}</textarea>
										...
										<div class="form-group">
											...
											<select type="text" name="article_category_id" id="article_category_id" class="form-control @error('article_category_id') form-control-error @enderror" required="required">
												...
												<option value="{{ $article_categories->id }}" @if($article_categories->id == $article->article_category_id ) selected @endif>{{ $article_categories->title }}</option>
												@endforeach
											</select>
