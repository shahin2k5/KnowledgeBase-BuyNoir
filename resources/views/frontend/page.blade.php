				...
				<div class="row">
                    <div class="col">
                        <div class="px-4 py-5 px-lg-5 bg-white">
                            <h3 class="mb-3" style="font-weight: bolder; color: #0ea1e2"><b>{{$page->title}}</b></h3>
                            <div class="row align-items-center gx-2 mb-4">
                                ...
                                <div class="col">
									...
									@endphp
                                    <p class="m-0 small" style="font-size: 16px; color: #0ea1e2"><b>Written by   {{$user->name}} </b></p>
                                    <p class="m-0 small" style="font-size: 16px;">Last updated: {{date('Y-m-d', strtotime($page->updated_at));}}</p>
                                </div>
                            </div>
