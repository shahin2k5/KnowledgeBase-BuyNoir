                        ...
                        <div class="widget-profile pro-widget-content">
                            <div class="profile-info-widget">
                                <a href="#" class="booking-doc-img">
                                    ...
                                    <img src="{{auth()->guard('patient')->user()->image}}" onerror="this.src='{{ asset('assets/frontend/img/patient.jpg') }}';" alt="User Image">
                                </a>
                                <div class="profile-det-info">
                                    <h3>{{auth()->guard('patient')->user()->name}}</h3>
                                    <div class="patient-details">
                                        <h5><i class="fas fa-venus-mars"></i> {{auth()->guard('patient')->user()->gender}}</h5>
                                        <h5><i class="fas fa-mobile-alt"></i> {{auth()->guard('patient')->user()->mobile}}</h5>
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                        <img class="avatar-img rounded-circle" src="/assets/frontend/img/doctors/doctor-thumb-01.jpg" alt="User Image">
                                                                    </a>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                        <img class="avatar-img rounded-circle" src="/assets/frontend/img/doctors/doctor-thumb-02.jpg" alt="User Image">
                                                                    </a>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                        <img class="avatar-img rounded-circle" src="/assets/frontend/img/doctors/doctor-thumb-03.jpg" alt="User Image">
                                                                    </a>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                        <img class="avatar-img rounded-circle" src="/assets/frontend/img/doctors/doctor-thumb-04.jpg" alt="User Image">
                                                                    </a>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                        <img class="avatar-img rounded-circle" src="/assets/frontend/img/doctors/doctor-thumb-05.jpg" alt="User Image">
                                                                    </a>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                        <img class="avatar-img rounded-circle" src="/assets/frontend/img/doctors/doctor-thumb-06.jpg" alt="User Image">
                                                                    </a>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                        <img class="avatar-img rounded-circle" src="/assets/frontend/img/doctors/doctor-thumb-07.jpg" alt="User Image">
                                                                    </a>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                        <img class="avatar-img rounded-circle" src="/assets/frontend/img/doctors/doctor-thumb-08.jpg" alt="User Image">
                                                                    </a>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                        <img class="avatar-img rounded-circle" src="/assets/frontend/img/doctors/doctor-thumb-09.jpg" alt="User Image">
                                                                    </a>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                        <img class="avatar-img rounded-circle" src="/assets/frontend/img/doctors/doctor-thumb-10.jpg" alt="User Image">
                                                                    </a>
